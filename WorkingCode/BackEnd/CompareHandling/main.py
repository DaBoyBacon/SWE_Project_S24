...
def testComparePlayerToGame():
    ...
    try:
        ...
        if(returnList[0][0] == "Game1" and returnList[1][0] == "Game2" and returnList[2][0] == "Game3"):
    ...
    try:
        ...
        if(returnList[0][0] == "Game3" and returnList[1][0] == "Game2" and returnList[2][0] == "Game1"):
